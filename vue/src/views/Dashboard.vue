  ...
  <PageComponent title="Dashboard">
    ...
    >
      ...
      >
        ...
        <div
          class="text-8xl fort-semibold flex-1 flex items-center justify-center"
        >
          {{ data.totalAnswers }}
        </div>
      </div>
      ...
      >
        ...
        <div class="flex fustify-between">
          <router-link
      ...
      >
        ...
        >
          <div class="fornt-semibold">{{ answer.survey.title }}</div>
          <small
            >Answer Made at:
            <em class="font-semibold">{{ answer.end_date }}</em></small
          >
        </a>
      </div>
    </div>
